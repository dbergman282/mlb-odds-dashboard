...
game_selected = st.sidebar.multiselect("Game", sorted(df_game["Game"].unique()), default=[])
market_selected = st.sidebar.multiselect("Market (Game)", sorted(df_game["market"].unique()), default=[])
bookmaker_selected = st.sidebar.multiselect("Bookmaker (Game)", sorted(df_game["bookmaker"].unique()), default=[])
...
bookmaker_batter = st.sidebar.multiselect("Bookmaker (Batter)", sorted(df_batter["bookmaker"].unique()), default=[])
market_batter = st.sidebar.multiselect("Market (Batter)", sorted(df_batter["market"].unique()), default=[])
...
bookmaker_pitcher = st.sidebar.multiselect("Bookmaker (Pitcher)", sorted(df_pitcher["bookmaker"].unique()), default=[])
market_pitcher = st.sidebar.multiselect("Market (Pitcher)", sorted(df_pitcher["market"].unique()), default=[])
